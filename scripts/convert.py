...
@click.option('--dest', default='/Users/kimshan/Public/data/mang_yuan2')
def main(src,dest):
    ...
    if pathinfo_csv_path.exists():
        ...
        with open(pathinfo_csv_path, 'w', newline='') as csv_file:
            ...
            csv_writer.writerow(['index', 'width', 'height', 'temp_l', 'temp_h', 'num_l', 'num_h', 'scale', 'path'])
    ...
    with open(pathinfo_csv_path, 'a', newline='') as csv_file:
        ...
        for path in convert.get_src_list():
            ...
            csv_writer.writerow([
                ...
                info['num_l'], info['num_h'], info['scale'], path
            ])
